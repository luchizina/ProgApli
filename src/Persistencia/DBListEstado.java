...
statement.executeUpdate();
    ...
    public void agregarListPrueb() {
        ...
        String[] referencias = {"Cine en el Botanico", "Cine en el Botanico", "Cine en el Botanico", "Cine en el Botanico", "Cine en el Botanico", "Religiosamente", "Religiosamente", "Religiosamente", "Religiosamente", "El Pimiento Indomable", "El Pimiento Indomable", "El Pimiento Indomable", "Pilsen Rock", "Pilsen Rock", "Pilsen Rock", "Romeo y Julieta", "Romeo y Julieta", "Romeo y Julieta", "Un día de Julio", "Un día de Julio", "Un día de Julio", "El Lazarillo de Tormes", "El Lazarillo de Tormes", "Durazno Rock"};
        for (int i = 0; i < 24; i++) {
            try {
